...
def test_even_better_draw_circles():
    ...
    print('--------------------------------------------')
    even_better_draw_circles(15, 15, rg.Point(100, 300), 'purple')
    even_better_draw_circles(5, 50, rg.Point(50, 50), 'magenta')


def even_better_draw_circles(n, number, center, color):
    window = rg.RoseWindow(400, 400)
